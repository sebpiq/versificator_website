...
// ########## Alpha shapes ########## //
// example:
//     triangles = alphaShapes([{x: 0, y: 0}, {x: 19, y: 90}, ...], 50)
//     
...
(function() {
  ...
  this.alphaShapes = function(vertices, alpha) {
    ...
    /* Yay, we're done! */
    return closed.filter(function(t) {
      return dsq(t.a, t.b) < asq && dsq(t.a, t.c) < asq && dsq(t.b, t.c) < asq
    });
  }
